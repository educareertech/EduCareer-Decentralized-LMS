...
import LoggedInMenuLayout from '../../Components/LoggedInMenuLayout.jsx';
import { Person, School, Checklist, ManageAccounts, Hub, CardMembershipRounded, Engineering, Category, CastForEducation, HealthAndSafety } from '@mui/icons-material';
...
function Welcome() {
  ...
  return (
    <>
      ...
      <section className='welcomeLandingSection'>
        <div className='ImageDiv'>
          <img src="digitalEducation.jpeg" alt="Image" />
          <div className='heading'>
            <h1>EduCareer Decentralized Learning Management System</h1>
          </div>
        </div>
        <div className='mainPageBoxes'>
          ...
          <div onClick={() => navigate('/Institutes')}>
            <i><School></School></i>
            <h3>Education</h3>
          </div>
          <div onClick={() => navigate('/TechServices')}>
            <i><Checklist></Checklist></i>
            <h3>Services</h3>
          </div>
          <div onClick={() => navigate('/TechServices')}>
      ...
      <div style={{marginTop:"7vw"}} className="LandingPage" >
        ...
        <div className='visionAndMission'>
          ...
          <div className='visionAndMissionRight GeneralFlexCenterRow'>
